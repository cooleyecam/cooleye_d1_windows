...
#define MAIN_THREAD_CPUID                  (1<<0)
#define LEFT_CAM_CAPTURE_THREAD_CPUID      (1<<1)
#define RIGHT_CAM_CAPTURE_THREAD_CPUID     (1<<2)
#define CAM_PREPROCESS_THREAD_CPUID        (1<<3)
#define CAM_SHOW_THREAD_CPUID              (1<<4)
#define IMU_THREAD_CPUID                   (1<<5)
...
//////   CAM D1  CAM setting
//////////////////////////////////////////////////////////////////////////
#define CAMD1_SYS_CLKIN 12000000
